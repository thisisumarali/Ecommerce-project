    ...
    return (
        <header className='mb-8 border-b'>
            <div className='flex items-center justify-between mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl'>
                <Link href="/">
                    <h1 className='text-2xl md:text-4xl font-bold'>Woo<span className='text-primary'>Commerce</span></h1>
                </Link>
                ...
                <div className='flex divide-x border-r sm:border-l'>
                    <Button variant={'outline'} onClick={() => handleCartClick()} className='flex flex-col gap-y-1.5 h-12 w-12 sm:h-20 sm:w-20 md:w-24 md:h-24 rounded-none'>
